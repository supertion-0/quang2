...
export class CustomerService {
  ...
  public addCustomerTempInfo(customerTempInfoDTO :CustomerTempInfoDTO): Observable<any>{
    const url = this.common.makeUrl("/customer/add_customer_info");
    return this.httpClient
    .post<any>(url,customerTempInfoDTO,this.httpOptions)
    .pipe(catchError(this.handleError));
  }
  public addCustomerClaim(customerClaim :CustomerClaim): Observable<any>{
    const url = this.common.makeUrl("/customer/add_customer_claim");
    return this.httpClient
    .post<any>(url,customerClaim,this.httpOptions)
    .pipe(catchError(this.handleError));
  }
